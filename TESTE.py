...
def calcular():
  ...
  def plot_intersecao(robo_x, robo_y, posicao_x, posicao_y, ball_x_inicial, ball_y_inicial, ball_x_final, ball_y_final):

    # Configurar o gráfico
    fig, ax = plt.subplots()

    # Traçar a rota do robô
    ax.plot([robo_x, posicao_x], [robo_y, posicao_y],
            'r-',
            label='Rota do Robô')

    # Traçar a rota da bola
    ax.plot([ball_x_inicial, ball_x_final], [ball_y_inicial, ball_y_final],
            'b-',
            label='Rota da Bola')

    # Adicionar ponto inicial e final do robô
    ax.plot(robo_x, posicao_x, 'go', label='Início do Robô')
    ax.plot(posicao_x, posicao_y, 'go', color='red', label='Fim do Robô')
    ...
    plot_intersecao(robo_x, robo_y, posicao_x, posicao_y, ball_x_inicial,
                    ball_y_inicial, ball_x_final, ball_y_final)
